...
class TestInstance(MongoDBTestCase):
    ...
    def test_embedded_document_to_mongo(self):
        ...
        assert list(Person(name="Bob", age=35).to_mongo().keys()) == [
            "_cls",
            "name",
            "age",
        ]
        assert list(Employee(name="Bob", age=35, salary=0).to_mongo().keys()) == [
            "_cls",
            "name",
            "age",
            "salary",
    ...
    def test_dynamic_document_pickle(self):
        ...
        assert resurrected == pickle_doc
        assert resurrected._fields_ordered == pickle_doc._fields_ordered
        assert list(resurrected._dynamic_fields.keys()) == list(
        ...
        assert list(resurrected.embedded._dynamic_fields.keys()) == list(
    ...
    def test_data_contains_id_field(self):
        ...
        assert "id" in list(person._data.keys())
